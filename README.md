...
- Python 3.x
- [plyer](https://pypi.org/project/plyer/) — for cross-platform desktop notifications
- [schedule](https://pypi.org/project/schedule/) — for running the reminder on a timer
